...
public interface CouponService {
    ...
    /**
     * 标记优惠券为已使用（不重新计算，用于订单创建时）
     */
    boolean markCouponAsUsed(String couponCode, String account, String orderId, BigDecimal discountAmount);

    /**
     * 根据订单ID释放优惠券（订单取消时调用）
     */
    boolean releaseCouponByOrderId(String orderId);
