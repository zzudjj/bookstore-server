...
public class CouponController {
    ...
    public Map<String, Object> calculateCouponDiscount(@RequestBody Map<String, Object> request) {
        try {
            String account = getCurrentUserAccount();
    ...
    public Map<String, Object> validateCoupon(@RequestBody Map<String, Object> request) {
        try {
            String account = getCurrentUserAccount();
            String couponCode = (String) request.get("couponCode");
            BigDecimal orderAmount = new BigDecimal(request.get("orderAmount").toString());
